const data = [
  {
    ...
    product: {
      model: "Iphone 14 Max",
      image:
        "https://cdn.macbro.uz/macbro/d35cfadb-2308-42fe-b7f5-da7dd24a4b74",
      realPrice: 1420,
      givenMoney: 600,
      percent: 40,
      consumption: 14,
  ...
  },
  {
    ...
    product: {
      ...
      image:
        "https://cdn.macbro.uz/macbro/9f8317e9-493a-4c5b-8ccd-19e34f529212",
      realPrice: 400,
      givenMoney: 200,
      consumption: 14,
      percent: 50,
  ...
  },
  {
    ...
    product: {
      ...
      term: 4,
      image:
        "https://cdn.macbro.uz/macbro/397b968b-7ae8-44e7-9336-dd04b7440bb1",
      calcWentOutAmount() {
        return this.realPrice - this.givenMoney + this.consumption;
      },
      calcTotalAmount() {
  ...
  },
  {
    ...
    product: {
      ...
      term: 8,
      image:
        "https://cdn.macbro.uz/macbro/e4574dbe-73d2-4cfb-b5b2-65cd3d149021",
      calcWentOutAmount() {
        return this.realPrice - this.givenMoney + this.consumption;
      },
      calcTotalAmount() {
...
data.map((data) => {
  ...
  const userInformation = `
    ...
    <div class="user__right--information">
        <h2 class="model-name ${
          product.model
        }">Foydalanuvchini ma'lumotlari</h2>
        <div class="user--desc ">
            <div class="user--photo ${product.model}">ID${id}</div>
            <div class="user--desc__detail">
                <h2>
                    Foydalanuvchi ismi: <span class="user--name">${name
                      .split(" ")[0]
                      .toUpperCase()}</span>
                </h2>
                <h2>
        ...
        <div class="user__responsible">
            <h3>
                ...
                <span class="user__responsible--imei">${
                  responsiblePerson.imei?.split(" ")[1]
                }</span>
            </h3>
            <h3>
                Telefonga mas'ul odam :
                <span class="user__responsible--name">${
